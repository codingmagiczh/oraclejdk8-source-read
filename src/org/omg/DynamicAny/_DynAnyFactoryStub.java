...
public class _DynAnyFactoryStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.DynamicAny.DynAnyFactory
{
  ...
  private void readObject (java.io.ObjectInputStream s) throws java.io.IOException
  {
     ...
     if (iorCheckEnabled() && !allowCorbanameInIOR()) {
       if (!str.startsWith("IOR:")) {
         throw new java.io.IOException("DynAnyFactory only supports IOR format for Stringified Object Reference:  " + str);
       }
     }
     String[] args = null;
  ...
  private static boolean iorCheckEnabled() 
  {
     return !java.security.AccessController.doPrivileged(
       new java.security.PrivilegedAction<Boolean>() {
         public Boolean run() {
             return Boolean
               .getBoolean(
                 "org.omg.DynamicAny.DynAnyFactoryStub.disableIORCheck");
         }
       });
  }
     ...
     return java.security.AccessController.doPrivileged(
       new java.security.PrivilegedAction<Boolean>() {
         public Boolean run() {
             return Boolean
               .getBoolean(
                 "com.sun.CORBA.DynamicAny.Stubs.allowCorbanameInIOR");
         }
       });
  }
